                ...
                <div className="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        {/* <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            <li className="breadcrumb-item text-sm"><a className="opacity-5 text-dark" href="javascript:void(0);">Pages</a></li>
                            <li className="breadcrumb-item text-sm text-dark active" aria-current="page">Dashboard</li>
                        </ol> */}
                        <h6 className="font-weight-bolder mb-0">{heading_title}</h6>
                    </nav>
                            ...
                            <li className="nav-item d-flex align-items-center justify-content-center">
                                {
                                    ...
                                    </div></> : state.agentToken ?
                                        <button className="btn btn-primary m-0" onClick={()=>logoutHelper("agent")}>
