...
const Addschoolname = () => {
    ...
    const updateData = async () => {
        try {
            ...
            let response = await axios
                .post(process.env.REACT_APP_NODE_URL + "/admin/updateschoolname", fd)
                    ...
                    <div className="row addCountryPage flex flex-row">
                        <div className="shadow-lg w-5/12 mx-auto my-4 p-2">
                            <div className="card-body">
                                ...
                                <div className="mb-3">
                                    {
                                        state.updatedId == null ?
                                            <input
                                                ...
                                                type="text" className="block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm   " name="schoolName" value={state.schoolName} onChange={handleChange} /> :
                                            <input
                                                disabled
                                                placeholder="Enter School Name"
                                                type="text" className="block w-full flex-1 border-gray-300 focus:border-black border-2 border-gray p-2 w-full focus:ring-indigo-500 sm:text-sm   " name="schoolName" value={state.schoolName} onChange={handleChange} />
                                ...
                                <button type="button" class="btn bg-gradient-primary w-100 ml-2 mt-4 text-white px-2 py-1 rounded mb-0" onClick={() => state.submitProcessing ? null : state.updatedId != null ? updateData() : uploadData()}>  
                                    {
                                                                ...
                                                                <td className="text-sm text-gray-900 font-light p-2 whitespace-nowrap">
                                                                    <img width={100} src={
                                                                        !school.schoolLogo ?
                                                                            ...
                                                                            process.env.REACT_APP_NODE_URL + "/uploads/agent/" + school.schoolLogo} alt="" />
                                                                </td>
                                                                <td className="text-sm text-gray-900 font-light p-2 whitespace-nowrap">
                                                                    <i className="fa-solid fa-pen-to-square cursor-pointer" onClick={() => setUpdate(index)}></i>
                                                                </td>
                                                            </tr>
                                                        })
                                                    }
