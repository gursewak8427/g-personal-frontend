...
const CreateSubAdmin = () => {
    ...
    const Create = () => {
        var data = { first_name: state.fname, last_name: state.lname, password: state.password, email: state.email, role: "SUBADMIN" }
        axios.post(process.env.REACT_APP_NODE_URL + "/admin/registersubadmin", data).then(res => {
    ...
    return (
        <>
            <Dashboard heading_title={"Create Sub-Admin"}>
                <>
