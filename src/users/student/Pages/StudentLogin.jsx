...
const StudentLogin = () => {
    ...
    const LoginNow = async () => {
        ...
        axios.post(process.env.REACT_APP_NODE_URL + "/student/login", data).then(res => {
            console.log(res)
                        ...
                        <div className="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto mh-100vh">
                            <div className="card card-plain mt-8">
                                <div className="card-header pb-0 text-left bg-transparent">
                                    <h3 className="font-weight-bolder text-info text-gradient">Student Login</h3>
                                ...
                                <div className="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p className="mb-4 text-sm mx-auto">
                                        ...
                                        <Link to="/student/register" className="text-info text-gradient font-weight-bold"> Sign up</Link>
                                    </p>
                                </div>
                            </div>
                        </div>
